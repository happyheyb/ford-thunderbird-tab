var SETTINGS = {
	imagesUrl: 'https://www.happyhey.com/new-tab/ford-thunderbird-tab-list.txt',
	noScript: 'https://www.happyhey.com/share/ford-thunderbird-tab/share.php?noscript=Yes',
	getUrl: 'https://www.happyhey.com/share/ford-thunderbird-tab/getUrl.php',
	bannerUrl: 'https://www.happyhey.com/banner5/ford-thunderbird-tab.php'
}
	...
	jQuery.ajax({
		...
		if(data.indexOf('happyhey.com') || data.indexOf('imgbox'))
		{
			...
			var share = new ShareButton({
				...
				title: "Do You Like Ford Thunderbird?",
				description: "Get awesome Ford Thunderbird HD images in each new Chrome tab!"
			});
			share.open();
		}
	})
